...
bool isAdmin = false;
int userCount = 2;
std::string* loginArr = new std::string[userCount]{ "123", "321" };
std::string* passwordArr = new std::string[userCount]{ "321", "123" };
//----------------------------------------
...
void CreateStaticStorage()
{
	...
	{
		"Гроб", "Памятник",
		"Услуга Киллера", "Aренда могилы",
		"Привет из могилы", "Лопата", "Костюм",
		"Кремационная урна", "Крест", "Ритуальные атрибуты"
	};
	int countStaticArr[staticSize]{ 68, 14, 9, 99, 41, 57, 33, 28, 11, 100 };
	double priceStaticArr[staticSize]{ 2500.0, 5700.0, 10000.0, 1600.0, 1300.0, 300.0, 1800.0, 2600.0, 3000.0, 4300.0 };
